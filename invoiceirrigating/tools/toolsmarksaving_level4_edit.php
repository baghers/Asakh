<?php 
/*
tools/toolsmarksaving_level4_edit.php
...
if (! $_POST)
{
    ...
    $Gadget3ID=$linearray[0];//شناسه سطح 3 ابزار
...
*/     
    ...
    if (!$resquery["FullTitle"]) header("Location: ../logout.php");
}
...
if ($_POST){
    ...
    {
        mysql_query("delete from toolsmarks WHERE Gadget3ID ='$Gadget3ID' and ProducersID='$ProducersID' 
                and toolsmarksid not in (select toolsmarksid from invoicedetail union all 
    ...
    foreach ($ID as $key => $value)
    {
        ...
        if ($_POST["marks$value"]=='on')
        {
            ...
            select distinct '$Gadget3ID','$ProducersID','$value','".date('Y-m-d H:i:s')."','".date('Y-m-d')."','$login_userid' from toolsmarks
            where not EXISTS  (select toolsmarksid from toolsmarks  WHERE Gadget3ID ='$Gadget3ID' and ProducersID='$ProducersID' 
            and MarksID='$value');";
            //print $sql;
...
?>
			...
			<!-- content -->
			<div id="content">
                <form action="toolsmarksaving_level4_edit.php" method="post">
                   <table width="600" align="center" class="form">
                    ...
                    <div style = "text-align:left;"><a  href=<?php print "toolsmarksaving_level4_list.php?uid=".rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).$Gadget2ID.'_'.$ProducersID.rand(10000,99999); ?>><img style = "width: 4%;" src="../img/Return.png" title='بازگشت' ></a></div>
                     ...
                     <tr>
                     <td width="20%" class="label">نام کالا:</td>
                      <td width="80%" class="data"><input readonly name="Title" type="text" class="textbox" id="Title" value="<?php echo $Title; ?>" size="50" maxlength="6" /></td>
                     </tr>
                    ...
                    print "
					 ...
					 $query="select MarksID as _value,MarksID as _key from toolsmarks where Gadget3ID='$Gadget3ID' and ProducersID='$ProducersID'";
