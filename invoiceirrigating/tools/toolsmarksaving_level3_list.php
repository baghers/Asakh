...
tools/toolsmarksaving_level2_list.php
*/
...
$formname='toolsmarksaving_level3';
...
<html>
<head>
  	<title>لیست ابزار سطح 2 جهت ثبت مارک <?php print $LevelTitle; ?></title>
		...
		<div id="wrapper">
			...
			<div id="content">
                <table width="95%" align="center">
                    <tbody>
                        <td></td>
                            <h1 align="center">  لبست ابزار سطح 2 جهت ثبت مارک برای تولیدکننده <?php print $LevelTitle; ?> </h1>
                        
                            <div style = "text-align:left;"><a href=<?php print "toolsmarksaving_level2_list.php?uid=".rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).$ProducersID.rand(10000,99999); ?>><img style = "width: 4%;" src="../img/Return.png" title='بازگشت' ></a></div>
                ...
                <table id="records" width="95%" align="center">
                   ...
                   <tbody><?php
                    ...
                    $cnt++;
                        $Code = $row['Code'];
                        $ID = $row['Gadget2ID'].'_'.$ProducersID;
                        $Title = $row['Title'];
?>
                        <tr>
                            <td><?php echo $Code; ?></td>
                            ...
                            <td><a href=<?php print "toolsmarksaving_level4_list.php?uid=".rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).$ID.rand(10000,99999); ?>>
