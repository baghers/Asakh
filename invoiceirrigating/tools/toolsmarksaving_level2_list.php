...
$formname='toolsmarksaving_level2';
...
$ProducersID = substr($_GET["uid"],40,strlen($_GET["uid"])-45);//شناسه تولید کننده
/*
...
<html>
<head>
  	<title>لیست ابزار سطح 1 جهت ثبت مارک <?php print $LevelTitle; ?></title>
		...
		<div id="wrapper">
			...
			<div id="content">
                <table width="95%" align="center">
                    <tbody>
                        <td></td>
                            <h1 align="center">  لبست ابزار سطح 1 جهت ثبت مارک برای تولیدکننده <?php print $LevelTitle; ?> </h1>
                        
                            <div style = "text-align:left;"><a href=<?php print "toolsmarksaving_level1_list.php"; ?>><img style = "width: 4%;" src="../img/Return.png" title='بازگشت' ></a></div>
                ...
                <table id="records" width="95%" align="center">
                   ...
                   <tbody><?php
                    ...
                    $cnt++;
                        $Code = $row['Code'];
                        $ID = $row['Gadget1ID'].'_'.$ProducersID.'_1';
                        $Title = $row['Title'];
?>
                        <tr>
                            <td><?php echo $Code; ?></td>
                            <td><?php echo $Title; ?></td>
                            <td><a href=<?php print "toolsmarksaving_level3_list.php?uid=".rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).$ID.rand(10000,99999); ?>>
