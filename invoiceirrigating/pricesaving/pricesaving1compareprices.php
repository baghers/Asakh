<?php 
/*
pricesaving/pricesaving1compareprices.php
...
if (! $_POST)
{
    ...
    $uid=$_GET["uid"];//آدرس ارسالی
    $linearray = explode('_',$PriceListMasterID);//شناسه لیست قیمت
    $PriceListMasterID=$linearray[0];    
       ...
       */
        $sql="SELECT producers.title producerstitle,marks.title markstitle,gadget2.gadget2id, 
            ...
            ,pricelistdetail.Price,CONCAT(CONCAT(gadget1.Title,'-'),gadget2.Title) Gadget12Title   
            FROM toolsmarks
            inner join (
            SELECT gadget3ID,MarksID FROM pricelistdetail
            inner join toolsmarks on toolsmarks.toolsmarksid=pricelistdetail.toolsmarksid
            where PriceListMasterID='$PriceListMasterID' and pricelistdetail.Price>0
            group by gadget3ID,MarksID 
            having count(ProducersID)>1) comparable on comparable.gadget3ID=toolsmarks.gadget3ID and comparable.MarksID=toolsmarks.MarksID 
            inner join pricelistdetail on toolsmarks.toolsmarksid=pricelistdetail.toolsmarksid
            ...
            where PriceListMasterID='$PriceListMasterID' and pricelistdetail.Price>0 $cond 
        ";
        ...
        //print $sql;
         ...
         $sqlselect="select CONCAT(CONCAT(gadget1.Title,'-'),gadget2.Title) _key,gadget2.gadget2id _value from gadget2
            ...
            inner join gadget1 on gadget1.gadget1id=gadget2.gadget1id and gadget1.gadget1id<>68 
            inner join ((SELECT gadget3ID,MarksID,count(ProducersID) cnt FROM pricelistdetail
            inner join toolsmarks on toolsmarks.toolsmarksid=pricelistdetail.toolsmarksid  
            where PriceListMasterID='$PriceListMasterID' and pricelistdetail.Price>0 
            group by gadget3ID,MarksID 

            having count(ProducersID)>1
             
            )) comparable on comparable.gadget3ID=gadget3.gadget3ID
        ...
        $sqlselect="select  marks.title _key,marks.marksid _value from marks 
        inner join ((SELECT gadget3ID,MarksID,count(ProducersID) cnt FROM pricelistdetail
            inner join toolsmarks on toolsmarks.toolsmarksid=pricelistdetail.toolsmarksid
            where PriceListMasterID='$PriceListMasterID' and pricelistdetail.Price>0 
            group by gadget3ID,MarksID 
            having count(ProducersID)>1
            )) comparable on comparable.marksID=marks.marksID
...
?>
			...
			<!-- content -->
			<div id="content" >
            <form id='myform' action="compareprices.php" method="post">
...
?>
                        <tr>
                            <td colspan="4" ></td >
                            <td style = "border:1px solid black;border-color:#777;text-align:center;font-size:10;line-height:200%;font-family:'B Nazanin';width: 50px"><?php echo $arrayproducer[0]; ?></td >
                            <td style = "border:1px solid black;border-color:#777;text-align:center;font-size:10;line-height:200%;font-family:'B Nazanin';width: 50px"><?php echo $arrayproducer[1]; ?></td >
                            <td style = "border:1px solid black;border-color:#777;text-align:center;font-size:10;line-height:200%;font-family:'B Nazanin';width: 50px"><?php echo $arrayproducer[2]; ?></td >
                            <td style = "border:1px solid black;border-color:#777;text-align:center;font-size:10;line-height:200%;font-family:'B Nazanin';width: 50px"><?php echo $arrayproducer[3]; ?></td >
                            <td style = "border:1px solid black;border-color:#777;text-align:center;font-size:10;line-height:200%;font-family:'B Nazanin';width: 50px"><?php echo $arrayproducer[4]; ?></td >
                            <td style = "border:1px solid black;border-color:#777;text-align:center;font-size:10;line-height:200%;font-family:'B Nazanin';width: 50px"><?php echo $arrayproducer[5]; ?></td >
                            <td style = "border:1px solid black;border-color:#777;text-align:center;font-size:10;line-height:200%;font-family:'B Nazanin';width: 50px"><?php echo $arrayproducer[6]; ?></td >
                            <td style = "border:1px solid black;border-color:#777;text-align:center;font-size:10;line-height:200%;font-family:'B Nazanin';width: 50px"><?php echo $arrayproducer[7]; ?></td >
                        </tr>
                        ...
                        <tr>
                            ...
                            style = "border:1px solid black;border-color:#777;text-align:right;font-size:17;line-height:120%;font-family:'B Nazanin';<?php  if ($login_ProducersID>0) echo 'width: 490px'; else echo 'width: 250px';  ?>"
                            ...
                            style = "background-color:##ff00b8;border:1px solid black;border-color:#777;text-align:right;font-size:14;line-height:120%;font-family:'B Nazanin';width: 72px"
                             readonly type="text" class="textbox"  value="<?php echo number_format($arrayp['0']); ?>" size="10" /></div></td>
                            
                            <td class="data"><input  
                            style = "background-color:##ff00b8;border:1px solid black;border-color:#777;text-align:right;font-size:14;line-height:120%;font-family:'B Nazanin';width: 72px"
                             readonly type="text" class="textbox"  value="<?php echo number_format($arrayp['1']); ?>" size="10" /></div></td>
                            
                            <td class="data"><input  
                            style = "background-color:##ff00b8;border:1px solid black;border-color:#777;text-align:right;font-size:14;line-height:120%;font-family:'B Nazanin';width: 72px"
                             readonly type="text" class="textbox"  value="<?php echo number_format($arrayp['2']); ?>" size="10" /></div></td>
                            
                            <td class="data"><input  
                            style = "background-color:##ff00b8;border:1px solid black;border-color:#777;text-align:right;font-size:14;line-height:120%;font-family:'B Nazanin';width: 72px"
                             readonly type="text" class="textbox"  value="<?php echo number_format($arrayp['3']); ?>" size="10" /></div></td>
                            
                            <td class="data"><input  
                            style = "background-color:##ff00b8;border:1px solid black;border-color:#777;text-align:right;font-size:14;line-height:120%;font-family:'B Nazanin';width: 72px"
                             readonly type="text" class="textbox"  value="<?php echo number_format($arrayp['4']); ?>" size="10" /></div></td>
                            
                            <td class="data"><input  
                            style = "background-color:##ff00b8;border:1px solid black;border-color:#777;text-align:right;font-size:14;line-height:120%;font-family:'B Nazanin';width: 72px"
                             readonly type="text" class="textbox"  value="<?php echo number_format($arrayp['5']); ?>" size="10" /></div></td>
                            
                            <td class="data"><input  
                            style = "background-color:##ff00b8;border:1px solid black;border-color:#777;text-align:right;font-size:14;line-height:120%;font-family:'B Nazanin';width: 72px"
                             readonly type="text" class="textbox"  value="<?php echo number_format($arrayp['6']); ?>" size="10" /></div></td>
                            
                            
                            <td class="data"><input  
                            style = "background-color:##ff00b8;border:1px solid black;border-color:#777;text-align:right;font-size:14;line-height:120%;font-family:'B Nazanin';width: 72px"
                             readonly type="text" class="textbox"  value="<?php echo number_format($arrayp['7']); ?>" size="10" /></div></td>
