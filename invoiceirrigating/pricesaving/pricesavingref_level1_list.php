...
$sql = "select producers.ProducersID,producers.Title from producers
...
<html>
<head>
  	<title>لیست تولیدکنندگان جهت ثبت مارک قیمتی مرجع</title>
...
?>
                        <tr>
                            ...
                            <td><a href=<?php print "pricesavingref_level2_list.php?uid=".rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).$ID.rand(10000,99999); ?>>
