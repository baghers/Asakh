...
$formname='pricesaving3masterlist';
...
?>                      
                        <tr>
                            ...
                            <td><a href=<?php print "pricesaving3masterlist_exportexcel.php?uid=".rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).$ID.rand(10000,99999); ?>>
                            <img style = 'width: 65%;' src='../img/mail_send.png' title='ارسال فایل '></a></td>
