...
$tblname='primaryinvoicedetail';//ریز پیش فاکتور تولید کننده

if ($login_Permission_granted==0) header("Location: ../login.php");

if ($_POST)
    {
        $Discont = str_replace(',', '', $_POST['Discont']);//تخفیف
            $TransportCost = str_replace(',', '', $_POST['TransportCost']);//هزینه حمل
       $primaryInvoiceMasterID = $_POST['primaryInvoiceMasterID'];//شناسه پیش فاکتور    
       /*
			...
			<div id="content" ><?php
				...
				if ($_POST){
					if ($register){
                        ...
                        $Serial = "";
                        if (!$_POST['tempsubmit'])
                        header("Location: "."producerinvoicemaster_list.php?uid=".rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).$ApplicantMasterID.rand(10000,99999));
...
?>
            <form action="producerinvoicedetail_list.php" method="post" onSubmit="return CheckForm()"  enctype="multipart/form-data">
...
";  ?>
    ...
    <br />
                            ...
                            <button title='جستجوی کالا' style="cursor:pointer;width:55px;height:70px;background-color:transparent; border-color:transparent;" type="button" onclick="openWin()">
                           <img style = 'width: 60%;' src='../img/mail_search.png' ></button > 
                          <a  href=<?php print "producerinvoicemaster_list.php"; ?>><img style = "width: 2%;" src="../img/Return.png" title='بازگشت' ></a>
                          </div>
                ...
                <a href=<?php 
                            ...
                            <img style = 'width: 2%;' src='../img/search.png' title=' ريز '></a></td>            
                
                <table id="records" width="100%" align="center" border="1">
                    <thead>
                        <tr>
						<td></td><td></td>
                            <th class="f13_fontb" width="5%" colspan="2" align="center">ردیف</th>
                            <th class="f13_fontb" width="50%" colspan="1" align="center">عنوان کالا</th>
                            <th class="f13_fontb" width="10%">تولید کننده/ فروشنده</th>
                            <th class="f13_fontb" width="10%">مارک</th>
                            <th class="f13_fontb" width="5%">واحد</th>
                            <th class="f13_fontb" width="5%">مقدار</th>
                            <th class="f13_fontb" width="10%" colspan="1">فی</th>
                            <th class="f13_fontb" width="20%" colspan="2">جمع مبلغ</th>
							 <th class="f13_fontb" width="1%"></th>
                            <th class="f13_fontb" width="1%"></th>
                            <th class="f13_fontb" width="5%"></th>
...
?>
                   ...
                   FilterComboboxes('$cnt', '$_server_httptype://$_SERVER[HTTP_HOST]/$home_path_iri/insert/producerinvoicedetail_list_jr.php',0,this.tabIndex);\"",
                            ...
                            <td class="data"><div id="divutitle<?php echo $cnt; ?>"><input  onmouseover="Tip(<?php echo '(\''.$utitle.'\')'; ?>)" name="utitle<?php echo $cnt; ?>" type="text" class="textbox" id="utitle<?php echo $cnt; ?>" value="<?php echo $utitle; ?>" style='width: 100%'  readonly /></div></td>
                            
                            <td class="data"><div id="divNumber<?php echo $cnt; ?>"><input  
                            
                             onmouseover="Tip(<?php echo '(\''.$Number.'\')'; ?>)" name="Number<?php echo $cnt; ?>" tabindex="<?php echo $tabindex; ?>" type="text" class="textbox" id="Number<?php echo $cnt; ?>" value="<?php echo $Number; ?>" style='width: 100%' maxlength="12"
                            
                            <?php 
							echo "onchange = \"FilterNextCombobox('$cnt');\"
                            ...
                            <td class='data'><div id='divSumPrice$cnt'><input  name='SumPrice$cnt' type='text' class='textbox' id='SumPrice$cnt' value='$SumPrice' style='width: 150px' readonly /></div>
                            ...
                            echo 
                            "<td class='data' ><div id='divEmptyPrice$cnt'><input  name='EmptyPrice$cnt' type='text' class='textbox' id='EmptyPrice$cnt' style='width: 100%' maxlength='12'  readonly /></div></td>
                            <td class='data'><div id='divEmptySumPrice$cnt'><input  name='EmptySumPrice$cnt' type='text' class='textbox' id='EmptySumPrice$cnt' style='width: 150px' readonly /></div>
                        ...
                        //print $pricelessprimaryinvoice.'sa';
                            ...
                            else
                            {
                                        ...
                                        and ifnull(toolsmarks.hide,0)=0
                                        left outer join operator on operator.operatorID=gadget3.operatorID
                                        left outer join spec2 on spec2.spec2id=gadget3.spec2id
                                        left outer join spec3 on spec3.spec3id=gadget3.spec3id
                                        left outer join sizeunits spec3sizeunits on spec3sizeunits.SizeUnitsID=gadget3.spec3sizeunitsid
