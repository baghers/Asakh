...
insert/invoicedetail_list_jr.php
...
$querys = "SELECT ifnull(ValueInt,0) ValueInt FROM supervisorcoderrquirement WHERE KeyStr ='pricelessinvoice' ";
...
$Array=ConvertFileToArray($_SERVER['DOCUMENT_ROOT'].'/cfg.txt');
   ...
   $font_style_string="";
	...
	$masterProducersID=$_POST['masterProducersID'];
	$selectedmarksID=$_POST['selectedmarksID'];
    $selectedgadget3ID=$_POST['selectedgadget3ID'];
    $selectedgadget2ID=$_POST['selectedgadget2ID'];
    
    $selectedProducersID=$_POST['selectedProducersID'];
    ...
    //ÝÞØ ÔÑ˜Ê åÇí ãÌÑí ÈÊæÇääÏ ÞíãÊ ÕÝÑ ÈÏåäÏ
...
*/
        ...
        $strgadget3synthetic="select gadget3.* from gadget3 where gadget3.gadget3ID in 
                                    ...
                                    where gadget3ID not in (
                                                            ...
                                                            inner join pricelistdetail on ifnull(pricelistdetail.hide,0)=0 and   pricelistdetail.ToolsMarksID=
        ...
        select gadget3.* from gadget3
                            ...
                            left outer join toolspref on toolspref.PriceListMasterID='$_POST[PriceListMasterID]' and toolspref.ToolsMarksID=toolsmarks.ToolsMarksID
                            inner join pricelistdetail on ifnull(pricelistdetail.hide,0)=0 and    
    ...
    if ($operatorProducersID!=$masterProducersID)
    {
        $condition.=" inner join toolsmarks toolsmarksp on gadget3.gadget3ID=toolsmarksp.gadget3ID and toolsmarksp.ProducersID='$masterProducersID' ";
        $con2=" and toolsmarks.producersID='$masterProducersID'";
        $con3=" and producers.producersID='$masterProducersID' ";
    ...
    else if ($selectedProducersID>0)
    {
        ...
        $condition.=" inner join toolsmarks toolsmarksp on gadget3.gadget3ID=toolsmarksp.gadget3ID and toolsmarksp.producersID='$selectedProducersID' ";
        $con2=" and toolsmarks.producersID='$selectedProducersID'";
        $con3=" and producers.producersID='$selectedProducersID' ";    
    ...
    if ($pricelessinvoice==0)
            ...
            inner join gadget3 on gadget3.gadget3id=toolsmarks.gadget3id and gadget3.gadget2id in (202,376,494,495) union all 
    ...
    $query4="select distinct gadget3.gadget3ID as _value,
        ...
        inner join gadget1 on gadget1.gadget1ID=gadget2.gadget1ID  and IsCost=0  and ifnull(gadget3.IsHide,0)=0
    ...
    $query4="select distinct  gadget3.gadget3ID as _value,
        ...
        inner join $strgadget3 on gadget3.gadget2ID=gadget2.gadget2ID  and ifnull(gadget3.IsHide,0)=0
        left outer join sizeunits sizeunitszavietoolsorattabaghe on sizeunitszavietoolsorattabaghe.SizeUnitsID=gadget3.zavietoolsorattabagheUnitsID left outer join sizeunits sizeunitsfesharzekhamathajm on sizeunitsfesharzekhamathajm.SizeUnitsID=gadget3.fesharzekhamathajmUnitsID left outer join sizeunits on sizeunits.SizeUnitsID=gadget3.sizeunitsID
        left outer join operator on operator.operatorID=gadget3.operatorID
        left outer join spec2 on spec2.spec2id=gadget3.spec2id
        left outer join spec3 on spec3.spec3id=gadget3.spec3id
    ...
    if ($pricelessinvoice==0)
        ...
        inner join  toolsmarks on toolsmarks.gadget3ID='$selectedgadget3ID' and toolsmarks.producersID=producers.producersID
            ...
            select distinct producers.producersID as _value,producers.Title as _key from producers
            inner join toolsmarks on toolsmarks.producersID=producers.producersID $con3
            inner join gadget3 on gadget3.gadget3id=toolsmarks.gadget3id and gadget3.gadget2id in (202,376,494,495) and gadget3.gadget3id='$selectedgadget3ID' union all 
    ...
    $query2="Select '0' As _value, ' ' As _key Union All  
        ...
        $query="Select gadget2ID from gadget3 where gadget3ID='$selectedgadget3ID' ";
                                     
            $result = mysql_query($query);  
            $row = mysql_fetch_assoc($result); 	
            $selectedgadget2ID=$row['gadget2ID'];
            
            
            
    if ($selectedgadget2ID!=376 && $selectedgadget2ID!=202 && $selectedgadget2ID!=495 && $selectedgadget2ID!=494)
    $query3="Select '0' As _value, ' ' As _key Union All  
        select distinct marks.marksID as _value,marks.Title as _key from gadget1 
        inner join gadget2 on gadget2.gadget1ID=gadget1.gadget1ID 
        inner join $strgadget3 on gadget3.gadget2ID=gadget2.gadget2ID and gadget3.gadget3ID='$selectedgadget3ID'
    ...
    $query4="select distinct  gadget3.gadget3ID as _value,
        ...
        from gadget1
        inner join gadget2 on gadget2.gadget1ID=gadget1.gadget1ID  and IsCost=0 
        inner join $strgadget3 on gadget3.gadget2ID=gadget2.gadget2ID and gadget3.gadget3ID='$selectedgadget3ID'  and ifnull(gadget3.IsHide,0)=0
        left outer join sizeunits sizeunitszavietoolsorattabaghe on sizeunitszavietoolsorattabaghe.SizeUnitsID=gadget3.zavietoolsorattabagheUnitsID left outer join sizeunits sizeunitsfesharzekhamathajm on sizeunitsfesharzekhamathajm.SizeUnitsID=gadget3.fesharzekhamathajmUnitsID left outer join sizeunits on sizeunits.SizeUnitsID=gadget3.sizeunitsID
        left outer join operator on operator.operatorID=gadget3.operatorID
        left outer join spec2 on spec2.spec2id=gadget3.spec2id
        left outer join spec3 on spec3.spec3id=gadget3.spec3id
    ...
    $query4="select distinct  gadget3.gadget3ID as _value,
        ...
        from gadget1
        inner join gadget2 on gadget2.gadget1ID=gadget1.gadget1ID and gadget2.gadget2ID='$selectedgadget2ID'  and IsCost=0 
        inner join gadget3 on gadget3.gadget2ID=gadget2.gadget2ID and gadget3.gadget3ID='$selectedgadget3ID' and ifnull(gadget3.IsHide,0)=0
        left outer join sizeunits sizeunitszavietoolsorattabaghe on sizeunitszavietoolsorattabaghe.SizeUnitsID=gadget3.zavietoolsorattabagheUnitsID left outer join sizeunits sizeunitsfesharzekhamathajm on sizeunitsfesharzekhamathajm.SizeUnitsID=gadget3.fesharzekhamathajmUnitsID left outer join sizeunits on sizeunits.SizeUnitsID=gadget3.sizeunitsID
        left outer join operator on operator.operatorID=gadget3.operatorID
        left outer join spec2 on spec2.spec2id=gadget3.spec2id
        left outer join spec3 on spec3.spec3id=gadget3.spec3id
    ...
    $query4="select distinct gadget3.gadget3ID as _value,replace(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(gadget2.Title,' '),ifnull(materialtype.title,'')),' '),ifnull(spec1,'')),' '),ifnull(gadget3.Title,'')),CONCAT(' ' ,CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(ifnull(size11,''),''),ifnull(operator.Title,'')),''),ifnull(size12,'')),''),ifnull(size13,' ')),CONCAT(ifnull(sizeunits.title,''),' ') ))),ifnull(zavietoolsorattabaghe,'')),''),ifnull(sizeunitszavietoolsorattabaghe.title,'')),''),ifnull(spec2.title,'')),' '),ifnull(fesharzekhamathajm,'')),''),ifnull(sizeunitsfesharzekhamathajm.title,'')),' '),CONCAT(CONCAT(CONCAT(CONCAT(CONCAT(ifnull(spec3.Title,''),''),ifnull(spec3size,'')),''),ifnull(spec3sizeunits.title,'')),' ')),''),' '),' '),'  ',' ' ) as _key 
        ...
        $query1="select distinct _value,_key from ($query1) as v1";
	   ...
	   $selectstr1="<select $font_style_string $width Tabindex=\"".($_POST['Tabindex']+1)."\" name='ProducersID$rowNumber' 
        onmouseover=\"Tip('$selectedTitle')\" id='ProducersID$rowNumber' \" onchange = \"FilterComboboxes('$rowNumber', '$_server_httptype://$_SERVER[HTTP_HOST]/$home_path_iri/insert/invoicedetail_list_jr.php',0,this.tabIndex);\" >";
       ...
       $width=1;
       $width="style='width: ".$width."px'";         		
	   $selectstr2="<select $font_style_string $width Tabindex=\"0\" name='gadget2ID$rowNumber'  onmouseover=\"Tip('$selectedTitle')\" id='gadget2ID$rowNumber' \" onchange = \"FilterComboboxes('$rowNumber', '$_server_httptype://$_SERVER[HTTP_HOST]/$home_path_iri/insert/invoicedetail_list_jr.php',1,0);\" >";
        while($row = mysql_fetch_assoc($result))
	    {
       ...
       $width=75;
       $width="style='width: ".$width."px'";         		
	   $selectstr3="<select $font_style_string $width Tabindex=\"".($_POST['Tabindex']+2)."\" name='marksID$rowNumber'  onmouseover=\"Tip('$selectedTitle')\" id='marksID$rowNumber' \" onchange = \"FilterComboboxes('$rowNumber', '$_server_httptype://$_SERVER[HTTP_HOST]/$home_path_iri/insert/invoicedetail_list_jr.php',2,0);\" >";
        while($row = mysql_fetch_assoc($result))
	    {
       ...
       $width=1;
       $width="style='width: ".$width."px'";         		
	   $selectstr4="<select $font_style_string $width  name='gadget3ID$rowNumber'  onmouseover=\"Tip('$selectedTitle')\" id='gadget3ID$rowNumber' \" onchange = \"FilterComboboxes('$rowNumber', '$_server_httptype://$_SERVER[HTTP_HOST]/$home_path_iri/insert/invoicedetail_list_jr.php',3,0);\" >";
      ...
      $limited = array("9");if ( in_array($_POST['login_RolesID'], $limited)) $condlimited=' and pfd=1 ';
        ...
        if ($ToolsMarksID>0)
        {
            ...
            $linearray = explode('-',$_POST['pipestr']);
            $row2['ProducersID']=$linearray[0];
            $row2['PE32app']=$linearray[1];
            $row2['PE40app']=$linearray[2];
            $row2['PE80app']=$linearray[3];
            $row2['PE100app']=$linearray[4];
            ...
            else $guerypipeprice="left outer join pipeprice on pipeprice.Date=(select max(Date) from pipeprice where toolsmarks.ProducersID=pipeprice.ProducersID and  
            ...
            $queryp="Select case gadget3.gadget2id 
            when 202 then ROUND(gadget3.UnitsCoef2*case ifnull(invoicemaster.proposable,0) when 0 then pipepricew.PE80 else pipeprice.PE80 end) 
            ...
            when 494 then ROUND(gadget3.UnitsCoef2*case ifnull(invoicemaster.proposable,0) when 0 then pipepricew.PE40 else pipeprice.PE40 end)
            ...
            left outer join pricelistdetail on ifnull(pricelistdetail.hide,0)=0 and  pricelistdetail.PriceListMasterID='$_POST[PriceListMasterID]' 
