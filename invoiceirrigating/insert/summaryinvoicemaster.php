...
insert/summaryinvoicemaster.php
...
<body>
 ...
 <?php 
					$uid3='';$uid3='summaryinvoicemaster.php?uid='.$uid.'^1';
			 		$uid1='summaryinvoicemaster.php?uid='.$uid1;
			     	$uid='summaryinvoicemaster.php?uid='.$uid;
				    ...
				    </h1>                          <INPUT type="hidden" id="txtuserid" value="<?php print $login_userid; ?>"/>
                ...
                <table id="records" width="95%" align="center">
                   ...
                   $rown=0;
                    while($row = mysql_fetch_assoc($result)){
                        ...
                        $Code = $row['Code'];
                        $ID = $row['ApplicantMasterID'].'_1_0_0_'.$row['applicantstatesID'];
...
?>                      
                        <tr>
							...
							<td><a href=<?php print "states_detail.php?uid=".rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).rand(10000,99999).$row['ApplicantMasterID'].'_2'.rand(10000,99999); ?>>
                            <img style = "width: 45%;" src="../img/refresh.png" title=' مشاهده ریز عملیات ' ></a></td>
                            ...
                            print "<td><a href='summaryinvoice.php?uid=".rand(10000,99999).rand(10000,99999).
						   ...
						   <img style = 'width: 20px;' src='../img/table.png' title=' ثبت جدول زمانبندي '></a></td>";
                            else echo "<td/>";    
                            }
