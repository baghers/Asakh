...
<head>
	<meta charset="UTF-8">
	<title>7Learn.com - Side Sliding Menu CSS</title>
	<link rel="stylesheet" type="text/css" href="font-awesome.css" rel="stylesheet">
	<style type="text/css">
		body {
		  margin: 0px;
		  padding: 0px;
		  font-family: "Open Sans", arial;
		  background: url('tumblr_static_tumblr_static_gaussian_blur_gradient_desktop_1680x943_wallpaper-393751.jpg');
		  color: #fff;
		  font-weight: 300;
		}
		...
		@import url(css?family=Titillium+Web:300);
		.logo {}
		.settings {
		  height: 73px;
		  float: right;
		  background: url(startific.jpg);
		...
		<div class="scrollbar" id="style-1">
				...
				<li>
					<a href="http://startific.com">
						...
						<span class="share"> 
							...
							<script type="text/javascript" src="addthis_widget.js#pubid=ra-4ff17589278d8b3a"></script>
						...
						<span class="fb-like">  
							<iframe src="" scrolling="no" frameborder="0" style="border:none; overflow:hidden; height:35px;" allowTransparency="true"></iframe>
			...
			<li class="darkerli">
				<a href="http://startific.com">
					...
					<span class="nav-text">تکنولوژی</span>
				</a>
			</li>
			...
			<li class="darkerli">
				<a href="http://startific.com">
					...
					<span class="nav-text">ابزار وب</span>
				</a>
			</li>
