...
/*
$fp = fsockopen("www.", 8888, $errno, $errstr, 30);
if (!$fp) {
    echo "$errstr ($errno)<br />\n";
}
*/
if ($login_RolesID!=1) header("Location: ../login.php");

$permitrolsid = array("1");
/*if (in_array($login_RolesID, $permitrolsid)) print $permitrolsid;
*/
if ($_POST )
    {
		...
		if (substr($HeaderTitle,0,3) =='../')   
			{
			 //print substr($HeaderTitle.$_FILES["file1"]["name"],2);
             //exit;
           move_uploaded_file($_FILES["file1"]["tmp_name"],($HeaderTitle.$_FILES["file1"]["name"]));   
            }
        else {
                /*
...
<body >
	...
	<div id="container">
		...
		<div id="wrapper">
            ...
            <form action="instruction3.php" method="post" enctype="multipart/form-data">
